            ...
            <div className='items-center justify-center md:p-0 px-4 text-center'>
                ...
                <div className='flex justify-center flex-wrap p-2'>
                    {headings.slice(0, 4).map((heading, index) => (
                        ...
                        >
                            <img src={heading.svg} alt="" className='h-24 w-24 mx-auto fill-current text-[#0e9a48]' />
                            <h2 className='text-center text-sm font-bold text-gray-500 pt-3'>{heading.text}</h2>
                        </motion.div>
                    ))}
                </div>
            </div>
