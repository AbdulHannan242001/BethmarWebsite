                ...
                >
                    <div className="flex flex-col md:flex-row">
                        <div className="md:w-1/2 p-4 md:p-8 bg-accentRed-dark text-white">
                            <h2 className="font-poppins text-2xl md:text-4xl font-bold mb-4">Contact Us</h2>
                        ...
                        <div className="md:w-1/2 p-4 md:p-8">
                            ...
                            <Link to={'/contact'} className="font-montserrat bg-accentRed-dark text-white font-bold py-3 px-6 hover:bg-accentRed justify-center items-center flex md:inline-block text-xs md:text-sm">
                                Contact Now
                            </Link>
                        </div>
                    </div>
